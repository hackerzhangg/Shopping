						...
						<li class="col-sm-12 col-md-4 col-xs-12">
							<a href="javascript:;" class="clearfix">
								...
								<div class="right-text-con">
									<p class="name">会员用户</p>
									<p><span class="color-org"><s:property value="#session.userCount"/></span>数据<span class="iconfont">&#xe628;</span></p>
								</div>
							</a>
						</li>
						<li class="col-sm-12 col-md-4 col-xs-12">
							<a href="javascript:;" class="clearfix">
								...
								<div class="right-text-con">
									<p class="name">商品数量</p>
									<p><span class="color-blue"><s:property value="#session.productCount"/></span>数据<span class="iconfont">&#xe628;</span></p>
								</div>
							</a>
						</li>
						<li class="col-sm-12 col-md-4 col-xs-12">
				...
				<div class="server-panel panel panel-default">
					...
					<div class="panel-body clearfix">
						<div class="col-md-2">
							...
							<span class="info">Apache/2.4.4 (Win64) PHP/5.4.16</span>
						</div>
						<div class="col-md-2">
						...
						<div class="col-md-2">
							...
							<span class="info">5.7.25</span>
						</div>
						<div class="col-md-2">
							<p class="title">数据库信息</p>
							<span class="info">5.7.25-log </span>
						</div>
						<div class="col-md-2">
							<p class="title">服务器当前时间</p>
							<span class="info">2020-02-22 11:37:35</span>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="panel panel-default comment-panel">
					...
					<div class="panel-body">
						<div class="commentbox">
							...
							<!-- 显示用户留言 -->
							<s:iterator var="messages" value="#session.messages">
								    ...
								    <div class="comment-main">
								      <header class="comment-header">
								        <div class="comment-meta"><a class="comment-author" href="#">慕枫</a> 评论于
								          <time title="2020年6月2日 下午3:20" datetime="2014-08-31T03:54:20">2020-6-2 15:20</time>
								        </div>
								      </header>
								      <div class="comment-body">
								        <!-- <p><a href="#">@某人</a> 系统真不错！！！</p> -->
								        <p><s:property value="#messages.message"/></p>
								      </div>
								    </div>
								  </li>
							  </s:iterator>

		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					<div class="title">
						<strong>用户更新</strong>USER UPDATE
					</div>
					<div>
						<s:actionerror></s:actionerror>
					</div>
					<form id="registerForm"
						action="${ pageContext.request.contextPath }/user_updateUserInformation.action"
							...
							<tbody>
								<tr>
									...
									<td><input type="text" id="username" name="username"
										class="text" value="${existUser.username }" maxlength="20"
								...
								<tr>
									...
									<td><input type="password" id="password" name="password"
										class="text" value="${existUser.password }" maxlength="20"
										autocomplete="off" /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text" id="email" name="email"
										class="text" value="${existUser.email }" maxlength="200" /></td>
								</tr>
								<tr>
									<th>姓名:</th>
									<td><input type="text" id="name" name="name" class="text"
										value="${existUser.name }" maxlength="200" /></td>
								</tr>
								<tr>
									<th>性别:</th>
									<td><span class="fieldSet"> <label> <input
												type="radio" name="sex" value="男"
												<c:if test="${existUser.sex == '男'  }">checked</c:if> />男
										</label> <label> <input type="radio" name="sex" value="女"
												<c:if test="${existUser.sex == '女' }">checked</c:if> />女
										</label>
									</span></td>
								</tr>
								<tr>
									...
									<td><input type="text" id="phone" name="phone"
										class="text" value="${existUser.phone }"
								...
								<tr>
									...
									<td><input type="text" id="address" name="address"
										class="text" value="${existUser.address }" maxlength="200" /></td>
								</tr>
								<tr>
									<th>&nbsp;</th>
									<td><input type="submit" class="submit" value="同意以下协议并更新" />
									</td>
								</tr>
								<tr>
									<th>&nbsp;</th>
								...
								<tr>
									...
									<td>
										<div id="agreement" class="agreement" style="height: 200px;">
											<p>尊敬的用户欢迎您更新成为本网站会员。请用户仔细阅读以下全部内容。如用户不同意本服务条款任意内容，请不要注册或使用本网站服务。如用户通过本网站注册程序，即表示用户与本网站已达成协议，自愿接受本服务条款的所有内容。此后，用户不得以未阅读本服务条款内容作任何形式的抗辩。
											</p>
											<p>
						...
						<div class="login" style="background-color: #B0E0E6;">
							<div class="ad">
								<dl>
									<dt>更新即享受</dt>
									<dd>正品保障、正规发票</dd>

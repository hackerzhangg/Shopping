			...
			<div id="hotProduct" class="hotProduct clearfix">
				...
				<ul class="tabContent" style="display: block;">
					...
					<s:if test="products.size() !=0 ">
						<s:iterator var="products" value="products">
							<li>
								<a target="_blank" href="${ pageContext.request.contextPath }/product_findByPid.action?pid=<s:property value="#products.pid"/>">
									<img src="${pageContext.request.contextPath}/<s:property value="#products.image"/>" style="display: block;"/>
									<span style='color:green'>
											<s:property value="#products.pname"/>
									 </span>
									 <br/>
									 <span class="price" style='color:red'>
										 商城价： ￥<s:property value="#products.shop_price"/>/份
									 </span>
									 <br/>
									 <span class="price" style='color:rosybrown'>
										 市场价： ￥<del><s:property value="#products.market_price"/></del>/份
									 </span>
								</a>
							</li>
						</s:iterator>
					...
					<s:else>
						<font style="font-size: 20px">亲！你搜索的商品暂时还没有上线，请耐性等待哦！</font>
					</s:else>
				</ul>		
			</div>
		</div>
